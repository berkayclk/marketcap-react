    ...
    render() {
        ...
        element =    (this.state.GlobalResponse !== null && this.state.GlobalResponse !== undefined && this.state.GlobalResponse[GlobaMarketlApiDataProperties.quotes][this.state.SelectedCurrency] !== undefined ) ?
                            (
                                ...
                                <button class="pull-right dropdown-toggle collapsed" data-toggle="collapse" data-target="#global-stats-mobile-1" aria-expanded="false" aria-controls="global-stats-mobile-1"><span class="caret"></span></button>
                                </li>
                                </ul>
                                <div id="global-stats-mobile-1" class="collapse" style="height: 0px;">
                                <ul class="list-group">
                                <li class="list-group-item">24 Saatlik Pazar Hacmi : <strong><a href="/charts/"><span data-global-stats-volume="" data-global-currency-volume="">{this.getPriceFormat(this.state.GlobalResponse[GlobaMarketlApiDataProperties.quotes][this.state.SelectedCurrency][GlobaMarketlApiDataProperties.quotes_total_volume_24h])}</span></a></strong></li>
                                <li class="list-group-item">BTC Payı : <strong><a href="/charts/#dominance-percentage"><span data-global-stats-btc-dominance="">{this.state.GlobalResponse[GlobaMarketlApiDataProperties.active_cryptocurrencies]}</span>%</a></strong></li>
                                <li class="list-group-item">Aktif Kriptopara: <strong><a href="/all/views/all/"><span data-global-stats-cryptocurrencies="">{this.state.GlobalResponse[GlobaMarketlApiDataProperties.active_cryptocurrencies]}</span></a></strong></li>
                                <li class="list-group-item last">Borsa Sayısı: <strong><a href="/currencies/volume/24-hour/"><span data-global-stats-markets="">{this.state.GlobalResponse[GlobaMarketlApiDataProperties.active_markets]}</span></a></strong></li>
                                <li>
                                <CurrencySelector id="currency-selector-headindukator" Table="true" className="currency-selector" onChange={this.onSelectedCurrencyChange} value={this.state.SelectedCurrency} />
                                </li>
                                </ul>
                                </div>
                                </div>
                            ...
                            <div class="outer-container global-stats desktop hidden-xs">
                                <div class="container global-stats inside-box desktop">
                                    <div class="pull-left stats-col col-md-11">
                                        <ul class="list-inline stat-counters" data-global-stats-container="">
                                            <li>Aktif Kriptopara : <strong><a href="#"><span data-global-stats-cryptocurrencies=""></span></a></strong></li>
                                            <li><span class="icon-bullet">•</span> 24 Saatlik Pazar Hacmi : <strong><a href="#"><span data-global-stats-volume="" data-global-currency-volume=""></span></a></strong></li>
                                            <li><span class="icon-bullet">•</span>  : <strong><a href="#"><span data-global-stats-btc-dominance="">{this.state.GlobalResponse[GlobaMarketlApiDataProperties.bitcoin_percentage_of_market_cap]}</span>%</a></strong></li>
                                        </ul>
                                    </div>
                                    <div class="pull-right dropdowns-col col-md-1">
                                        <div >
